...
import 'package:nonton_id_by_ferian/screen/navbar/tiket_screen/jadwal_tiket.dart';

class BeliTiket extends StatelessWidget {
  final String judul;
  const BeliTiket({super.key, required this.judul});
